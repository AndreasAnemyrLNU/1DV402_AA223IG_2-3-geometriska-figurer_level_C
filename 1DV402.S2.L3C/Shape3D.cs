...
namespace _1DV402.S2.L3C
{
    public abstract class Shape3D : Shape
    {
        ...
        public override string ToString(string format)
        {
            ...
            {
              return string.Format("{0,-10}{1,6:F1}{2,6:F1}{3,6:F1}{4,13:F1}{5,13:F1}{6,15:F1}", ShapeType, _baseShape.Length, _baseShape.Width, Height, MantelArea, TotalSurfaceArea, Volume);
            }
            else
            {
